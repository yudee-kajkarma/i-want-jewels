...
export async function generateMetadata({
  ...
  return {
    ...base,
    alternates: localizedAlternates('/resources/jewellery-care-guides/new-year-jewellery-gifts', locale),
  }
}
...
const articleContent: V2ArticleSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'A fifth mistake is choosing the wrong metal colour. If she mostly wears gold, choose gold. If she usually wears white or silver tone, choose that direction.' },
...
export default function Page() {
  ...
  const article = getArticleBySlug('jewellery-care-guides', 'new-year-jewellery-gifts')
  if (!category || !article) notFound()
  const relatedArticles = getRelatedArticles('jewellery-care-guides', 'new-year-jewellery-gifts', 3)
  return (
