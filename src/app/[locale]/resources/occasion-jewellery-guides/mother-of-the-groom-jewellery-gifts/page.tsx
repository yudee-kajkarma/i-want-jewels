...
export async function generateMetadata({
  ...
  return {
    ...base,
    alternates: localizedAlternates('/resources/occasion-jewellery-guides/mother-of-the-groom-jewellery-gifts', locale),
  }
}
...
const heroIntro: V2HeroIntro = {
  ...
  paragraphs: [
    "Mother of the groom jewellery should feel elegant, thoughtful and wearable after the wedding day. It can be a thank-you gift, a welcome gift, a wedding morning gift or a meaningful piece chosen to honour her role in the celebration. The best gift should not feel like a one-day accessory. It should be something she can wear again for dinners, family events, anniversaries, holidays, wedding guest outfits and everyday moments.",
    "The safest jewellery gift for the mother of the groom is usually a pair of classic diamond studs. Drop earrings are ideal if her wedding outfit is formal, satin, structured or evening-ready. Butterfly earrings are strong when the gift should feel sentimental. Huggies work well if she prefers modern everyday jewellery. Minimalist earrings are best if her style is clean and understated.",
    "At IWantJewels, Cadenza M diamond stud earrings, Cadenza S lab-grown diamond studs, Orsola drop earrings, Concetta Long earrings, Concetta Short earrings, Alidi Farfalla butterfly earrings, Farfalla butterfly earrings, Amadea Huggie earrings and Laluce minimalist diamond earrings all work for different mother of the groom gift needs. Pave Hoops can work for a modern mother-of-the-groom outfit, while Lusso should only be used if she genuinely loves bold evening jewellery.",
  ],
  shopLabel: 'Shop Mother of the Groom Jewellery Gifts',
...
const quickSummary: V2QuickSummary = {
  items: [
    ...
    'Choose wedding jewellery gifts for the groom\'s mum.',
    ...
    'Match earrings to mother-of-the-groom dresses, colours, necklines and hairstyles.',
...
const articleContent: V2ArticleSection[] = [
  {
    heading: 'Mother of the Groom Jewellery Gift Selector',
    content: [
      { type: 'paragraph', text: 'Use this table as the main gift decision tool.' },
      {
        ...
        rows: [
          ['Safest mother of the groom gift', 'Medium diamond studs', 'Cadenza M'],
          ['Subtle wedding gift', 'Small diamond studs', 'Cadenza S'],
          ['Elegant wedding-day gift', 'Drop earrings', 'Orsola'],
          ['Formal mother of the groom gift', 'Long drops or polished studs', 'Concetta Long, Cadenza M'],
          ['Soft wedding outfit gift', 'Short drops or butterfly earrings', 'Concetta Short, Farfalla'],
          ["Meaningful wedding gift for groom's mum", 'Butterfly earrings', 'Alidi Farfalla, Farfalla'],
          ['Modern mother of the groom gift', 'Huggies', 'Amadea Huggie'],
          ['Minimalist mother of the groom gift', 'Minimalist earrings or small studs', 'Laluce, Cadenza S'],
          ['Wedding morning gift', 'Studs, butterfly earrings or drops', 'Cadenza M, Alidi Farfalla, Orsola'],
          ['Thank-you gift after the wedding', 'Drops, huggies or classic studs', 'Orsola, Amadea, Cadenza M'],
  ...
  {
    heading: 'What Makes Jewellery a Good Mother of the Groom Gift?',
    content: [
      { type: 'paragraph', text: 'A good mother of the groom jewellery gift should feel respectful, elegant and useful. It may be given by the groom, by the couple, or as part of a family thank-you moment. The gift should recognise her role without feeling too trend-led or too difficult to wear again.' },
      { type: 'paragraph', text: 'Earrings are especially strong because they do not require sizing and can be chosen around her outfit, hairstyle and personal taste. A pair of diamond studs can become a classic keepsake. A pair of drop earrings can complete her wedding-day outfit. Butterfly earrings can carry emotional meaning. Huggies or minimalist earrings can feel modern and practical if she prefers understated jewellery.' },
      {
        type: 'table',
        ...
        rows: [
          ...
          ['Personal meaning', 'The gift can feel like appreciation and family connection'],
          ...
          ['Timelessness', 'Mother-of-the-groom jewellery should not feel too trend-led'],
        ],
      },
  ...
  {
    heading: 'Safest Mother of the Groom Jewellery Gifts',
    content: [
      { type: 'paragraph', text: 'The safest mother of the groom jewellery gifts are classic diamond studs, elegant drops and understated huggies. These pieces are polished, versatile and easy to wear again.' },
      { type: 'paragraph', text: 'Cadenza M is the strongest safe gift because it feels refined and visible without being too bold. Cadenza S works better if she prefers subtle jewellery. Orsola is ideal if she enjoys elegant occasion outfits. Amadea and Laluce are better if she prefers modern or minimalist everyday styling.' },
      {
        type: 'table',
        ...
        rows: [
          ...
          ['Minimalist earrings', 'Understated mother-of-the-groom look', 'Laluce'],
  ...
  {
    heading: 'Mother of the Groom vs Mother of the Bride Jewellery Gifts',
    content: [
      { type: 'paragraph', text: 'Mother of the groom and mother of the bride jewellery gifts can follow the same styling rules. Both should feel elegant, comfortable and wearable beyond the wedding day. The main difference is the emotional role. A mother of the bride gift may feel like a wedding morning keepsake from the bride, while a mother of the groom gift may feel like a thank-you, welcome or appreciation gift from the groom or couple.' },
  ...
  {
    heading: 'Mother of the Groom Earrings by Dress Colour',
    content: [
      { type: 'paragraph', text: 'Dress colour is one of the easiest ways to choose earrings for the mother of the groom. The earrings should support the outfit and make the look feel finished without drawing attention away from the couple.' },
      {
        type: 'grid-layout',
        imagePosition: 'right',
  ...
  {
    heading: 'Mother of the Groom Earrings by Neckline',
    content: [
  ...
  {
    heading: 'Mother of the Groom Earrings by Hairstyle',
    content: [
  ...
  {
    heading: 'Mother of the Groom Jewellery by Wedding Style',
    content: [
  ...
  {
    heading: 'Diamond Studs for Mother of the Groom',
    content: [
      { type: 'paragraph', text: 'Diamond studs are one of the safest and most timeless mother of the groom jewellery gifts. They work with almost every dress colour, neckline and wedding style.' },
      { type: 'paragraph', text: 'Cadenza M diamond stud earrings are the strongest classic option because they feel polished and wedding-ready while still being wearable after the wedding. Cadenza S is better when she prefers subtle jewellery or when the gift should feel smaller and softer.' },
      {
        ...
        rows: [
          ['Safest mother of the groom gift', 'Cadenza M', 'Polished, timeless and elegant'],
          ['Subtle wedding gift', 'Cadenza S', 'Simple and wearable'],
          ['Mother of the bride gift', 'Cadenza M', 'Classic and suitable for many styles'],
        ...
        content: [
          {
            ...
            rows: [
              ...
              ['Formal mother of the groom gown', 'Long drops', 'Concetta Long'],
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: "For the mother of the groom, butterfly earrings can represent family growth, change, beauty and a new chapter. This makes Alidi Farfalla and Farfalla strong choices for a sentimental wedding morning gift, thank-you gift or welcome gift." },
      {
        type: 'table',
        headers: ['Butterfly Gift Need', 'Best Direction', 'Product Direction'],
        rows: [
          ['Most meaningful mother of the groom gift', 'Butterfly earrings', 'Alidi Farfalla'],
          ['Soft symbolic gift', 'Butterfly earrings', 'Farfalla'],
          ['Wedding morning gift', 'Butterfly earrings or studs', 'Alidi Farfalla, Cadenza M'],
          ['Mother of the bride sentimental gift', 'Butterfly earrings', 'Farfalla'],
  ...
  },
  {
    ...
    content: [
      { type: 'paragraph', text: 'Huggies and minimalist earrings are ideal if the mother of the groom prefers clean, modern and comfortable jewellery.' },
      { type: 'paragraph', text: 'Amadea Huggie earrings are strong because they can be worn on the wedding day and after. Laluce minimalist diamond earrings are better when the look should stay quiet and understated. Cadenza S can pair with either for a simple stack.' },
      {
        ...
        rows: [
          ['Modern mother of the groom gift', 'Huggies', 'Amadea'],
  ...
  {
    heading: 'Mother of the Groom Jewellery by Metal Colour',
    content: [
      ...
      { type: 'paragraph', text: 'For mother of the groom gifts, yellow gold is strong for warm wedding palettes, white or silver tone is strong for cool palettes, and rose gold is strong for soft sentimental styling.' },
  ...
  {
    heading: 'Product Pathways by Mother of the Groom Gift Need',
    content: [
      { type: 'subheading', text: 'For the Safest Mother of the Groom Gift' },
      ...
      { type: 'subheading', text: 'For a Formal Mother of the Groom Gift' },
      { type: 'paragraph', text: 'Choose Concetta Long earrings. They work best for black-tie weddings, evening gowns and formal mother-of-the-groom styling.' },
      ...
      { type: 'subheading', text: "For a Meaningful Wedding Gift for Groom's Mum" },
      ...
      { type: 'subheading', text: 'For a Modern Mother of the Groom Gift' },
  ...
  },
  {
    ...
    content: [
      {
        type: 'table',
        headers: ['Product', 'Best Mother of the Groom Gift Role', 'Why It Works'],
        rows: [
          ...
          ['Alidi Farfalla butterfly earrings', "Best meaningful gift for groom's mum", 'Personal, symbolic and sentimental'],
      ...
      { type: 'paragraph', text: 'Choose mother of the groom jewellery that feels elegant on the wedding day and wearable after it. Pick Cadenza M for classic sparkle, Orsola for graceful movement, Concetta Long for formal styling, Alidi Farfalla for meaning, Amadea for modern huggies and Laluce for understated elegance.' },
    ],
  },
  {
    heading: 'Common Mistakes to Avoid',
    content: [
      { type: 'paragraph', text: 'One common mistake is choosing earrings that are too trend-led for a formal family wedding look. Mother of the groom jewellery should usually feel elegant and timeless.' },
      ...
      { type: 'paragraph', text: 'Finally, do not forget comfort. The mother of the groom will wear the jewellery for many hours through photos, ceremony, dinner, speeches and dancing.' },
  ...
  },
  {
    ...
    content: [
      { type: 'paragraph', text: 'Before choosing mother of the groom jewellery, ask:' },
      {
        type: 'bullet-list',
        items: [
          'Is the gift for the mother of the groom, mother of the bride, stepmum, grandmother or mother figure?',
...
const faq: V2FAQItem[] = [
  { question: 'What jewellery is best for the mother of the groom?', answer: 'The best mother of the groom jewellery is elegant, comfortable and suited to her outfit. Diamond studs, drop earrings, butterfly earrings, huggies and minimalist earrings can all work depending on her dress and personal style.' },
  { question: 'Are earrings a good mother of the groom gift?', answer: 'Yes, earrings are a strong mother of the groom gift because they are easy to choose, can be worn on the wedding day and can still be used after the wedding.' },
  { question: "What earrings should the mother of the groom wear?", answer: 'The mother of the groom can wear diamond studs for a classic look, drop earrings for elegance, huggies for modern styling or butterfly earrings for meaningful detail.' },
  { question: 'What earrings are safest for the mother of the groom?', answer: 'Medium diamond studs are the safest choice because they are polished, timeless and easy to wear with many dress styles.' },
  { question: "What jewellery should I gift the groom's mum?", answer: "Classic diamond studs, elegant drop earrings, huggies or meaningful butterfly earrings can all work for the groom's mum depending on her style." },
  { question: 'Are butterfly earrings good for a mother of the groom gift?', answer: 'Yes, butterfly earrings can be meaningful because they can symbolise growth, beauty, transformation and new beginnings.' },
  { question: 'What earrings should the mother of the groom wear with a navy dress?', answer: 'A navy dress works well with medium diamond studs, drop earrings or huggies. Cadenza M, Orsola and Amadea are strong directions.' },
  { question: 'What earrings should the mother of the groom wear with a satin dress?', answer: 'A satin mother of the groom dress usually works best with drop earrings or medium diamond studs.' },
  { question: 'What metal colour is best for mother of the groom jewellery?', answer: 'Choose the metal colour that suits her dress and what she already wears. Yellow gold feels warm, white or silver tone feels clean, and rose gold feels soft and sentimental.' },
  { question: 'What IWantJewels earrings are best for mother of the groom gifts?', answer: 'Cadenza M, Cadenza S, Orsola, Concetta Long, Concetta Short, Alidi Farfalla, Farfalla, Amadea and Laluce are strong mother of the groom gift options depending on her outfit and style.' },
]

const cta: V2CTABlock = {
  heading: 'Mother of the groom jewellery should feel elegant on the wedding day and wearable after it. Choose diamond studs for classic polish, drop earrings for graceful movement, long drops for formal styling, butterfly earrings for meaning, huggies for modern comfort and minimalist earrings for understated elegance.',
  ...
  primaryLabel: 'Shop Mother of the Groom Jewellery Gifts',
  ...
  tertiaryLabel: 'Read the Mother of the Bride Jewellery Gifts Guide',
  tertiaryHref: '/resources/occasion-jewellery-guides/mother-of-the-bride-jewellery-gifts',
}

export default function Page() {
  const category = getCategoryBySlug('occasion-jewellery-guides')
  const article = getArticleBySlug('occasion-jewellery-guides', 'mother-of-the-groom-jewellery-gifts')
  if (!category || !article) notFound()
  const relatedArticles = getRelatedArticles('occasion-jewellery-guides', 'mother-of-the-groom-jewellery-gifts', 3)
  return (
