            ...
            <ul className="grid grid-cols-2 gap-x-6 gap-y-8 sm:grid-cols-4 sm:gap-x-4">
                {features.map((feature) => (
                    ...
                    >
                        ...
                        />
                        <p className="text-[12px] font-medium uppercase leading-[1.35] tracking-[0.14em] text-pink-500 sm:text-[13px]">
                            <span className="block">{feature.lines[0]}</span>
                            <span className="block">{feature.lines[1]}</span>
                        </p>
                    </li>
                ))}
            </ul>
