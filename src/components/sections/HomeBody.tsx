        ...
        <>
            ...
            <section className="mx-auto max-w-7xl px-4 py-12">
                <div className="grid gap-5 md:grid-cols-3">
                    {budgetCollections.map((item) => (
                        <article
                            key={item.title}
                            className="relative overflow-hidden rounded-[28px] p-6 text-white shadow-[0_20px_50px_rgba(138,78,95,0.22)]"
                        >
                            <img
                                src={item.image}
                                alt={item.title}
            ...
            <section className="mx-auto max-w-7xl px-4 py-12">
                <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
                    ...
                    <div>
                        <p className="text-sm font-semibold uppercase tracking-[0.16em] text-[#c5528d]">
                        ...
                        <p className="mt-5 max-w-xl text-base leading-7 text-zinc-600">
                            ...
                            Want Jewels creates refined jewellery with lab-grown
                            diamonds, 925 sterling silver, and elevated
          ...
          <div className="relative flex flex-col gap-8">
            ...
            <section className="mx-auto max-w-7xl px-4 py-12">
                <div className="text-center">
                    <h2 className="text-3xl font-semibold tracking-[-0.03em] text-[#1b140f]">
            ...
            <section className="mx-auto max-w-7xl px-4 py-12">
                <div className="grid gap-10 rounded-[34px] border border-[#f2e2d8] bg-[linear-gradient(180deg,#fffaf7_0%,#ffffff_100%)] p-8 shadow-[0_24px_60px_rgba(92,63,37,0.08)] lg:grid-cols-[1fr_0.9fr_1fr]">
                    <div>
                        ...
                        <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-[#1b140f]">
                            Valentine&apos;s Gift Card
                        </h2>
                        <p className="mt-3 text-base leading-7 text-zinc-600">
                            Give the gift of choice. Last-minute pick? This
                            jewellery gift card still feels considered, premium,
                            and personal.
                        </p>
                    ...
                    <div className="flex items-center justify-center rounded-[28px] border border-[#f2d4bf] bg-[#fff4ef] p-6">
                        <div className="w-full rounded-[24px] border border-[#efc6af] bg-white px-8 py-12 text-center shadow-sm">
                            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-[#9c7359]">
                                Valentine&apos;s
                            </p>
                            <p className="mt-2 text-5xl font-semibold tracking-[-0.05em] text-[#e35b97]">
                                Gift Card
                            </p>
                            <p className="mt-4 text-sm leading-6 text-zinc-500">
                                This gift card lets you choose a piece that
                                feels just right.
                            </p>
                            <p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-[#e35b97]">
                                I Want Jewels
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-5">
                        {serviceHighlights.map(
                            ({ title, description, Icon }) => (
                                <div
                                    key={title}
                                    className="flex items-start gap-4 rounded-[20px] bg-white p-4 shadow-sm"
                                >
                                    <span className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#fff1f7] text-[#ff4fae]">
                                        <Icon className="h-5 w-5" />
                                    </span>
                                    <div>
                                        <h3 className="text-sm font-semibold uppercase tracking-[0.08em] text-[#1b140f]">
                                            {title}
                                        </h3>
