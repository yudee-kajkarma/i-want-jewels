      ...
      <div className="mx-auto  px-4 py-10 lg:px-10 lg:py-12">
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.78fr_0.78fr_0.9fr_1.15fr] lg:gap-10">
          ...
          <div className="space-y-3 text-base text-zinc-800 lg:text-lg">
            <h4 className="text-xl font-semibold uppercase tracking-[0.01em] text-zinc-900">Infomation</h4>
          ...
          <div className="space-y-3 text-base text-zinc-800 lg:text-lg">
            <h4 className="text-xl font-semibold uppercase tracking-[0.01em] text-zinc-900">Quick Shop</h4>
          ...
          <div className="space-y-3 text-base text-zinc-800 lg:text-lg">
            <h4 className="text-xl font-semibold uppercase tracking-[0.01em] text-zinc-900">Customer Services</h4>
          ...
          <div>
            <h4 className="text-xl font-semibold uppercase tracking-[0.01em] text-zinc-900">Newletter</h4>
            ...
            <form className="mt-5 flex max-w-[400px] overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-[0_1px_0_rgba(17,24,39,0.03)]">
              ...
              />
              <button type="submit" className="m-1 flex h-12 w-12 items-center justify-center rounded-2xl bg-zinc-900 text-white transition hover:bg-zinc-800">
                <ArrowIcon />
              </button>
            </form>
